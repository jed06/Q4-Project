...
// giraffe.paint(g);
        ...
        g.drawString("Peppa will allow you to start making 'Guesses' when you've asked a few questions ", 10, 210);
        g.drawString("Be sure to know which card you think it is, before you make a guess", 10, 240);
        g.drawString("A Wrong Guess is an automatic win for the computer  ", 10, 270);
        g.drawString("May the Peppa Force be with you!", 10, 300);

        g.setFont(new Font ("Monospaced", Font.PLAIN, 40));
        g.drawString("\"",390, 310);
